...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "patch",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/clients/{clientMac}/name".format(
            omadacId=omadac_id,
            siteId=site_id,
...
def sync_detailed(
    ...
    *,
    ...
    """Set name for given client
     ...
     Set name for given client.<br/><br/>The interface requires one of the permissions:
