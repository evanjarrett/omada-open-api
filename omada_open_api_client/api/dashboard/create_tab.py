...
from ...models.create_tab import CreateTab
...
def sync_detailed(
    ...
    *,
    ...
    """Create new tab
     ...
     Create tab.<br/><br/>The interface requires one of the permissions:
    ...
    exist in current site.<br/>-34702  -  This tab name already exists.<br/>-34703  -  The number of
    tabs has reached the limit.
