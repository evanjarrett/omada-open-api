...
def _get_kwargs(
    ...
    return {
        "method": "get",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/dashboard/without-overall-tabs".format(
            omadacId=omadac_id,
            siteId=site_id,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get tab without overall tab list
     ...
     Get tabs without Overall Tab.<br/><br/>The interface requires one of the permissions:
