...
from ...models.update_tab import UpdateTab
...
def sync_detailed(
    ...
    *,
    ...
    exist in current site.<br/>-34701  -  This tab does not exist in the dashboard.<br/>-34702  -  This
    tab name already exists.<br/>-34704  -  Non-overall tabs do not allow editing system cards.
