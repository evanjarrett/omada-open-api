...
from ...models.operation_response_grid_vo_device_info import OperationResponseGridVODeviceInfo
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/devices".format(
            omadacId=omadac_id,
            siteId=site_id,
        ),
        "params": params,
...
) -> Optional[OperationResponseGridVODeviceInfo]:
    if response.status_code == HTTPStatus.OK:
        response_200 = OperationResponseGridVODeviceInfo.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[OperationResponseGridVODeviceInfo]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get device list
     ...
     Get device list.<br/><br/>The interface requires one of the permissions:
    <br/>DEVICES_READ<br/>MSP_DEVICES_READ
