...
from ...models.locate_device_request_info import LocateDeviceRequestInfo
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    json_body: LocateDeviceRequestInfo,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/devices/{deviceMac}/locate".format(
            omadacId=omadac_id,
            siteId=site_id,
...
def sync_detailed(
    ...
    *,
    ...
    """Locate device
     ...
     Locate device.<br/><br/>The interface requires one of the permissions:
    <br/>DEVICES_WRITE<br/><br/>The possible error code for the interface in the returned body is one of
    the following error codes (non generic error codes): <br/>-39005  -  Failed to adopt this device
