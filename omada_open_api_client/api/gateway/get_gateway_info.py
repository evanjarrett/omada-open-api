...
from ...models.operation_response_gateway_info_entity import OperationResponseGatewayInfoEntity
...
def _get_kwargs(
    ...
    return {
        "method": "get",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/gateways/{gatewayMac}".format(
            omadacId=omadac_id,
            siteId=site_id,
...
) -> Optional[OperationResponseGatewayInfoEntity]:
    if response.status_code == HTTPStatus.OK:
        response_200 = OperationResponseGatewayInfoEntity.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[OperationResponseGatewayInfoEntity]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get gateway info
     ...
     Get gateway info<br/><br/>The interface requires one of the permissions:
