...
from ...models.batch_update_given_switch_ports_profile_override_enable_setting_entity import (
...
def _get_kwargs(
    ...
    switch_mac: str,
    *,
    json_body: BatchUpdateGivenSwitchPortsProfileOverrideEnableSettingEntity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/switches/{switchMac}/multi-ports/profile-override".format(
            omadacId=omadac_id,
            siteId=site_id,
