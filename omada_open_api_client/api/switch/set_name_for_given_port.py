...
from ...models.update_the_given_switch_port_name_entity import UpdateTheGivenSwitchPortNameEntity
...
def _get_kwargs(
    ...
    port: str,
    *,
    json_body: UpdateTheGivenSwitchPortNameEntity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/switches/{switchMac}/ports/{port}/name".format(
            omadacId=omadac_id,
            siteId=site_id,
...
def sync_detailed(
    ...
    *,
    ...
    """Set name for given port
     ...
     Set name for given port.<br/><br/>The interface requires one of the permissions:
