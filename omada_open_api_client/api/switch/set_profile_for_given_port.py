...
from ...models.update_the_given_switch_port_profile_entity import UpdateTheGivenSwitchPortProfileEntity
...
def _get_kwargs(
    ...
    port: str,
    *,
    json_body: UpdateTheGivenSwitchPortProfileEntity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/switches/{switchMac}/ports/{port}/profile".format(
            omadacId=omadac_id,
            siteId=site_id,
...
def sync_detailed(
    ...
    *,
    ...
    """Set profile for given port
     ...
     Set profile for given port.<br/><br/>The interface requires one of the permissions:
