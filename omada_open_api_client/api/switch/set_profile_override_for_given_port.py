...
from ...models.update_the_given_switch_port_profile_override_enable_setting_entity import (
...
def _get_kwargs(
    ...
    port: str,
    *,
    json_body: UpdateTheGivenSwitchPortProfileOverrideEnableSettingEntity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/openapi/v1/{omadacId}/sites/{siteId}/switches/{switchMac}/ports/{port}/profile-override".format(
            omadacId=omadac_id,
            siteId=site_id,
