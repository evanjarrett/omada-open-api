...
T = TypeVar("T", bound="APLANTrafficEntity")


@_attrs_define
class APLANTrafficEntity:
    """LAN traffic info

    Attributes:
        rx_pkts (Union[Unset, int]): total rx packets
        tx_pkts (Union[Unset, int]): total tx packets
        rx (Union[Unset, int]): total rx bytes, Unit:Byte
        tx (Union[Unset, int]): total tx bytes, Unit:Byte
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aplan_traffic_entity.additional_properties = d
        return aplan_traffic_entity
