...
class DropEap:
    ...
    Attributes:
        dropouts (Union[Unset, List['Drop']]): AP dropouts timing list
        ...
        avg (Union[Unset, float]): Average current AP drop packet rate
        status (Union[Unset, int]): AP status
    """

    dropouts: Union[Unset, List["Drop"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        dropouts: Union[Unset, List[Dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for dropouts_item_data in _dropouts or []:
