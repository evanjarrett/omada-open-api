...
T = TypeVar("T", bound="GatewayPortConfigEntity")


@_attrs_define
class GatewayPortConfigEntity:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gateway_port_config_entity = cls(
            port=port,
        ...
        gateway_port_config_entity.additional_properties = d
        return gateway_port_config_entity
