...
if TYPE_CHECKING:
    from ..models.wire_guard_entity import WireGuardEntity


T = TypeVar("T", bound="GridVOWireGuardEntity")


@_attrs_define
class GridVOWireGuardEntity:
    """
    Attributes:
        total_rows (Union[Unset, int]):
        current_page (Union[Unset, int]):
        current_size (Union[Unset, int]):
        data (Union[Unset, List['WireGuardEntity']]):
    """

    total_rows: Union[Unset, int] = UNSET
    current_page: Union[Unset, int] = UNSET
    current_size: Union[Unset, int] = UNSET
    data: Union[Unset, List["WireGuardEntity"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = WireGuardEntity.from_dict(data_item_data)

            data.append(data_item)

        grid_vo_wire_guard_entity = cls(
        ...
        grid_vo_wire_guard_entity.additional_properties = d
        return grid_vo_wire_guard_entity
