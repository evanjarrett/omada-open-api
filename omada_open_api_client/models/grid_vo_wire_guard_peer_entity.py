...
if TYPE_CHECKING:
    from ..models.wire_guard_peer_entity import WireGuardPeerEntity


T = TypeVar("T", bound="GridVOWireGuardPeerEntity")


@_attrs_define
class GridVOWireGuardPeerEntity:
    """
    Attributes:
        total_rows (Union[Unset, int]):
        current_page (Union[Unset, int]):
        current_size (Union[Unset, int]):
        data (Union[Unset, List['WireGuardPeerEntity']]):
    """

    total_rows: Union[Unset, int] = UNSET
    current_page: Union[Unset, int] = UNSET
    current_size: Union[Unset, int] = UNSET
    data: Union[Unset, List["WireGuardPeerEntity"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = WireGuardPeerEntity.from_dict(data_item_data)

            data.append(data_item)

        grid_vo_wire_guard_peer_entity = cls(
        ...
        grid_vo_wire_guard_peer_entity.additional_properties = d
        return grid_vo_wire_guard_peer_entity
