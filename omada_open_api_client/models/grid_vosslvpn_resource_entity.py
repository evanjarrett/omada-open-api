...
if TYPE_CHECKING:
    from ..models.sslvpn_resource_entity import SSLVPNResourceEntity
...
class GridVOSSLVPNResourceEntity:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_vosslvpn_resource_entity = cls(
        ...
        grid_vosslvpn_resource_entity.additional_properties = d
        return grid_vosslvpn_resource_entity
