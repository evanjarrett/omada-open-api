...
if TYPE_CHECKING:
    from ..models.sslvpn_user_group_entity import SSLVPNUserGroupEntity


T = TypeVar("T", bound="GridVOSSLVPNUserGroupEntity")


@_attrs_define
class GridVOSSLVPNUserGroupEntity:
    """
    Attributes:
        total_rows (Union[Unset, int]):
        current_page (Union[Unset, int]):
        current_size (Union[Unset, int]):
        data (Union[Unset, List['SSLVPNUserGroupEntity']]):
    """

    total_rows: Union[Unset, int] = UNSET
    current_page: Union[Unset, int] = UNSET
    current_size: Union[Unset, int] = UNSET
    data: Union[Unset, List["SSLVPNUserGroupEntity"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_vosslvpn_user_group_entity = cls(
        ...
        grid_vosslvpn_user_group_entity.additional_properties = d
        return grid_vosslvpn_user_group_entity
